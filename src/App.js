    ...
    <div style={{}}>
      ...
      <Box style={{ margin: '0px auto', padding: '0px 50px', maxWidth: '1500px' }}>
        ...
        <Box style={{ display: 'block', position: 'relative', top: '-33px' }}>
          <Box>
            <Typography style={{ fontWeight: '600', fontSize: '30px', letterSpacing: '0px', color: 'rgb(4,17,29)', fontFamily: 'Poppins,sans-serif' }}>userName</Typography>
            <Typography style={{ color: 'rgb(53, 56, 64)', fontWeight: '300' }}>ethereum id</Typography>
          </Box>
